...
nohup python -u main_sgd.py --lam 1e-6 --dataset MNIST --projection 0 --compare_baseline_nonconvergent 1 --gpu 4 >./MNIST_SGD_compare_baseline.log 2>&1 </dev/null &
nohup python -u main_sgd.py --lam 1e-6 --dataset CIFAR10 --projection 0 --compare_baseline_nonconvergent 1 --gpu 5 >./CIFAR10_SGD_compare_baseline.log 2>&1 </dev/null &
...
#nohup python -u main_sgd.py --lam 1e-6 --dataset CIFAR10 --projection 0 --paint_unlearning_sigma 1 --gpu 5 >./CIFAR10_SGD_paint_unlearning_sigma_001.log 2>&1 </dev/null &
