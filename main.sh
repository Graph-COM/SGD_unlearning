...
#nohup python -u main_sgd.py --lam 1e-6 --dataset MNIST --sequential 1 --gpu 0 >./MNIST_SGD_sequential.log 2>&1 </dev/null &
#nohup python -u main_sgd.py --lam 1e-6 --dataset CIFAR10 --sequential 1 --gpu 3 >./CIFAR10_SGD_sequential.log 2>&1 </dev/null &

# paint unlearning unlearning - sigma figure
#nohup python -u main_sgd.py --lam 1e-6 --dataset MNIST --paint_unlearning_sigma 1 --gpu 4 >./MNIST_SGD_paint_unlearning_sigma.log 2>&1 </dev/null &
#nohup python -u main_sgd.py --lam 1e-6 --dataset CIFAR10 --paint_unlearning_sigma 1 --gpu 5 >./CIFAR10_SGD_paint_unlearning_sigma.log 2>&1 </dev/null &
