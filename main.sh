...
#nohup python -u main_sgd.py --lam 1e-7 --sigma 0.01 --dataset MNIST --paint_utility_epsilon 1 --gpu 1 >./MNIST_LMC_paint_utility_epsilon.log 2>&1 </dev/null &
#nohup python -u main_sgd.py --lam 1e-7 --sigma 0.01  --dataset CIFAR10 --paint_utility_epsilon 1 --gpu 6 >./CIFAR10_LMC_paint_utility_epsilon.log 2>&1 </dev/null &
